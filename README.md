...
## Notices
- Sigma Spy will have bugs, please report any bugs by opening an [issue](https://github.com/sirlin7777777-afk/spyy/issues) on Github
- If you gave a suggestion, please post it in the [discussions](https://github.com/sirlin7777777-afk/spyy/discussions)
- Please do not use Potassium in games with Actors as Potassium's crude implimentations break

## Loadstring
```lua
--// Sigma Spy @sirlin7777777-afk
loadstring(game:HttpGet("https://raw.githubusercontent.com/sirlin7777777-afk/spyy/refs/heads/main/Main.lua"), "Sigma Spy")()
```
